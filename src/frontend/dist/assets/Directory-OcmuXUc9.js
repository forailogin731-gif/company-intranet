import { u as reactExports, v as useDirection, w as useControllableState, l as jsxRuntimeExports, R as Root2$1, x as useId, y as useComposedRefs, z as Anchor, P as Primitive, D as composeEventHandlers, E as useLayoutEffect2, F as Portal$1, G as reactDomExports, H as createPopperScope, J as createCollection, V as VISUALLY_HIDDEN_STYLES, K as useCallbackRef, O as hideOthers, Q as useFocusGuards, T as ReactRemoveScroll, W as FocusScope, X as DismissableLayer, Y as createContextScope, Z as createSlot, _ as Content, $ as Arrow, C as ChevronDown, a0 as cn, a1 as employees, a2 as departments, S as Search, a3 as Input, p as Link, A as Avatar, r as AvatarImage, s as AvatarFallback, q as Badge } from "./index-6T0_xeqr.js";
import { m as motion, C as Card, a as CardContent } from "./proxy-C-7JP5f1.js";
import { C as Check, a as ChevronUp, E as ExternalLink } from "./external-link-oqH_2fZm.js";
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: deptFilter, onValueChange: setDeptFilter, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
              ...
              departments.map((d) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: d.name, children: d.name }, d.id))
            ] })
          ] })
        ]
      }
    ...
    filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium", children: "No employees found" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-1", children: "Try adjusting your search or filter" })
        ]
      }
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4", children: filtered.map((emp, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        initial: { opacity: 0, y: 12 },
        animate: { opacity: 1, y: 0 },
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5 flex flex-col items-center text-center gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Avatar, { className: "h-16 w-16", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { className: "bg-primary/10 text-primary font-semibold", children: emp.name.split(" ").map((n) => n[0]).join("") })
                ] }),
                emp.isOnline && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute bottom-0.5 right-0.5 h-3 w-3 rounded-full bg-accent border-2 border-card" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 w-full", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground group-hover:text-primary transition-colors truncate", children: emp.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground truncate", children: emp.role }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "mt-2 text-[11px]", children: emp.department })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full space-y-1.5 pt-2 border-t border-border", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs text-muted-foreground", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-3.5 w-3.5 flex-shrink-0" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: emp.location })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs text-muted-foreground", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "h-3.5 w-3.5 flex-shrink-0" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: emp.email })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 text-[11px] text-primary opacity-0 group-hover:opacity-100 transition-smooth", children: [
