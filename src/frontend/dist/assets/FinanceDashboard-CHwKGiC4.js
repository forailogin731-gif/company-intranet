import { u as clsx, R as React, as as getDefaultExportFromCjs, v as reactExports, w as jsxRuntimeExports, T as TrendingUp } from "./index-2fslUrt3.js";
...
import { C as ChartColumn, T as Target } from "./target-Cy91wxSH.js";
import { f as filterProps, _ as _baseExtremum, r as _baseGt, s as _baseIteratee, t as _baseLt, g as isFunction, v as Text, w as polarToCartesian, L as Layer, x as getTickClassName, y as adaptEventsOfChild, z as Label, D as Dot, C as Curve, b as isNil, j as getValueByDataKey, S as Shape, A as Animate, F as get, a as interpolateNumber, d as isEqual, i as isNumber, e as LabelList, u as uniqueId, G as Global, H as mathSign, p as findAllByType, o as Cell, I as getMaxRadius, J as getPercentValue, K as warn, l as generateCategoricalChart, M as formatAxisMap, R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, N as Legend, B as Bar } from "./generateCategoricalChart-B7LSTHKo.js";
import { B as BarChart } from "./BarChart-oVI9OG01.js";
import { C as CartesianGrid } from "./CartesianGrid-stlWiZ02.js";
import { C as ChartPie } from "./chart-pie-CTQw_U_N.js";
...
function CustomTooltip({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-border bg-popover shadow-elevated px-3 py-2.5 text-xs text-popover-foreground", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold mb-1.5 text-foreground", children: label }),
    payload.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-0.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
...
function PieTooltip({ active, payload }) {
  if (!active || !(payload == null ? void 0 : payload.length)) return null;
  const d = payload[0];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-border bg-popover shadow-elevated px-3 py-2 text-xs text-popover-foreground", children: [
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 pb-2 border-b border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl bg-primary/15 p-2.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BadgeIndianRupee, { className: "h-6 w-6 text-primary" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-foreground", children: "Finance Dashboard" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "P&L, budgeting & cost analytics — Nexus Manufacturing" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ml-auto text-right", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "FY 2025–26" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground", children: "April 2026" })
          ] })
        ] }),
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                KPICard,
                {
                  ...
                  value: "₹1.50 Cr",
                  sub: "April 2026",
                  icon: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingDown, { className: "h-5 w-5" }),
                  trend: "stable",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Card,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-5 pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 280, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: revenueExpenseData, barGap: 4, barCategoryGap: "28%", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  CartesianGrid,
                  {
                    strokeDasharray: "3 3",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 xl:grid-cols-5 gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Card,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-auto max-h-80", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-2.5 text-xs font-medium text-muted-foreground", children: "Department" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right px-3 py-2.5 text-xs font-medium text-muted-foreground", children: "Allocated" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right px-3 py-2.5 text-xs font-medium text-muted-foreground", children: "Spent" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right px-3 py-2.5 text-xs font-medium text-muted-foreground", children: "Remaining" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2.5 text-xs font-medium text-muted-foreground", children: "Utilization" })
                  ] }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: budgetData.map((row, i) => {
                    const pct = Math.round(row.spent / row.allocated * 100);
                    const barColor = pct >= 90 ? "bg-destructive" : pct >= 75 ? "bg-accent" : "bg-primary";
                    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "tr",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2.5 font-medium", children: row.dept }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-3 py-2.5 text-right tabular-nums text-muted-foreground", children: [
                            "₹",
                            row.allocated,
                            "L"
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-3 py-2.5 text-right tabular-nums font-medium", children: [
                            "₹",
                            row.spent,
                            "L"
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-3 py-2.5 text-right tabular-nums text-chart-5", children: [
                            "₹",
                            row.remaining,
                            "L"
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2.5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-1.5 rounded-full bg-muted overflow-hidden min-w-[60px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "div",
                              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Card,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-base font-semibold flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ChartPie, { className: "h-4 w-4 text-chart-5" }),
                  "Cost Center Breakdown"
                ] }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-4 pb-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 200, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Pie,
                      {
                        ...
                        paddingAngle: 2,
                        dataKey: "value",
                        children: costCenterData.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                          Cell,
                          {
                            fill: CHART_COLORS[costCenterData.indexOf(entry) % CHART_COLORS.length],
                            strokeWidth: 0
                          },
                          entry.name
                        ))
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 space-y-1.5", children: costCenterData.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold tabular-nums text-foreground", children: [
                          item.value,
                          "%"
                        ] })
                      ]
